...
import 'package:talktalk/ui/page/chat/formatter.dart';
...
class Bubble extends StatelessWidget {
    ...
    return Row(
      ...
      children: [
        if (chat.type == ChatMessageType.received)
          const CircleAvatar(
            backgroundImage: AssetImage("assets/images/talktalk_origin.png"),
          ),
        Container(
  ...
  EdgeInsets get paddingOnType {
    switch (chat.type) {
      ...
      case ChatMessageType.received:
        return const EdgeInsets.only(top: 10, bottom: 10, left: 24, right: 10);
    }
  }
}